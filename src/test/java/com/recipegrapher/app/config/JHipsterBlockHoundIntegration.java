package com.recipegrapher.app.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.recipegrapher.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.recipegrapher.app.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
